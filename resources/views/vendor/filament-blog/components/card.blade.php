...
<a href="{{ route('filamentblog.post.show', ['post' => $post->slug]) }}">
    <div class="group/blog-item flex flex-col gap-y-5">
        <div class="h-[200px] sm:h-[250px] w-full rounded-xl bg-zinc-300 overflow-hidden">
        ...
        <div class="flex flex-col justify-between space-y-3 px-2">
            <h2 title="{{ $post->title }}"
                class="group-hover/blog-item:text-primary-700 mb-3 line-clamp-2 text-lg font-semibold hover:text-blue-600">
                {{ $post->title }}
            </h2>
