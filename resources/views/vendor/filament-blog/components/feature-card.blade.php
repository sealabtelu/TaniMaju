@props(['post'])
<div class="grid md:grid-cols-2 gap-y-5 gap-x-5 md:gap-x-10">
    <div class="h-[250px] md:h-[400px] w-full overflow-hidden rounded-xl bg-zinc-300">
    ...
    <div class="flex flex-col justify-center space-y-5 py-4 md:pl-10">
        <div>
            <div class="mb-5">
                <a href="{{ route('filamentblog.post.show', ['post' => $post->slug]) }}" class="mb-4 block text-lg md:text-4xl font-semibold hover:text-blue-600">
                    {{ $post->title }}
                </a>
                <div>
