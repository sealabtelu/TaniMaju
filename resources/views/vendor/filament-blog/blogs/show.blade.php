                        ...
                        <div>
                            <div class="flex flex-col justify-end">
                                <div class="mb-6 h-full w-full overflow-hidden rounded bg-slate-200">
                                    <img class="flex h-full min-h-[400px] items-center justify-center object-cover object-top text-sm font-semibold text-slate-400" src="{{ $post->featurePhoto  }}" alt="{{ $post->photo_alt_text }}">
                                </div>
                                <div class="mb-6">
                                ...
                                <div>
                                    ...
                                    <div class="pt-10">
                                        ...
                                        <div class="space-x-2 space-y-1">
                                            ...
                                            <a href="{{ route('filamentblog.tag.post', ['tag' => $tag->slug]) }}" class="rounded-full border border-slate-300 px-3 py-1 text-sm font-medium text-slate-600 hover:bg-slate-100">
                                                {{ $tag->name }}
                                            </a>
                                            @endforeach
                                        </div>
                            ...
                            <div class="flex flex-col gap-y-6 divide-y">
                                ...
                                <article class="pt-4 text-base">
                                    <div class="mb-4 flex items-center gap-4">
                                        <!-- <img class="h-14 w-14 overflow-hidden rounded-full border-4 border-white bg-zinc-300 object-cover text-[0] ring-1 ring-slate-300" src="{{ asset($comment->user->avatar_url) }}" alt="avatar"> -->
                                        <div>
