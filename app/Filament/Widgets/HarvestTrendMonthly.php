...
class HarvestTrendMonthly extends ChartWidget
{
    ...
    protected function getData(): array
    {
        ...
        $monthlyHarvest = DB::table('hasil_panens')
            ->select(DB::raw('DATE_FORMAT(updated_at, "%Y-%m") as month'), DB::raw('SUM(jumlah_hasil_panen) as total'))
            ->groupBy('month')
            ->orderBy('month')
            ->get();
